...
#cp ../../ewp-reference-connector/ewp-reference-connector/target/ewp-reference-connector-2.0-SNAPSHOT.war local-ewp/ewp-data

cd local-registry 
./setup.sh https://local.ewp.uma.es/ewp/rest/manifest https://test.ewp.uma.es/ewp/rest/manifest
